	...
	tmp = make_rotZ( theta );
      ...
      *strchr(line, '\n') = 0;
      ...
      sscanf(line, "%lf %lf %lf %lf %lf %lf %lf %lf",
	     xvals, yvals, xvals + 1,
	     yvals+1, xvals+2, yvals+2, xvals + 3, yvals + 3);
      
      add_curve(edges, * xvals, * yvals, * (xvals + 1), * (yvals + 1),
		* (xvals + 2), * (yvals + 2), * (xvals + 3), * (yvals+ 3), STEP, 0);    
    }//end bezier
      ...
      //these are rates
      add_curve(edges, * xvals, * yvals, * (xvals + 1), * (yvals + 1),
		* (xvals + 2), * (yvals + 2), * (xvals + 3), * (yvals+ 3), STEP, 1);
    }//end hermite
      ...
      add_circle(edges, * xvals, * yvals, * zvals, r, STEP);
